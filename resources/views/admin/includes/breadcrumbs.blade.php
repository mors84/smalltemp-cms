<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        {{-- All Employees --}}
        @elseif (Route::is('employees.index'))
            <h2>{{trans('admin.allEmployees')}}&nbsp;({{$employees->total()}})</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="{{route('admin')}}">{{trans('admin.home')}}</a>
                </li>
                <li class="active">
                    <strong>{{trans('admin.allEmployees')}}</strong>
                </li>
            </ol>

        {{-- Add Employee --}}
        @elseif (Route::is('employees.create'))
            <h2>{{trans('admin.addEmployee')}}</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="{{route('admin')}}">{{trans('admin.home')}}</a>
                </li>
                <li>
                    <a href="{{route('employees.index')}}">{{trans('admin.employees')}}</a>
                </li>
                <li class="active">
                    <strong>{{trans('admin.addEmployee')}}</strong>
                </li>
            </ol>

        {{-- Edit Employee --}}
        @elseif (Route::is('employees.edit'))
        ...
        {{-- All Companies --}}
        @elseif (Route::is('companies.index'))
            <h2>{{trans('admin.allCompanies')}}&nbsp;({{$companies->total()}})</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="{{route('admin')}}">{{trans('admin.home')}}</a>
                </li>
                <li class="active">
                    <strong>{{trans('admin.allCompanies')}}</strong>
                </li>
            </ol>

        {{-- Add Company --}}
        @elseif (Route::is('companies.create'))
            <h2>{{trans('admin.addCompany')}}</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="{{route('admin')}}">{{trans('admin.home')}}</a>
                </li>
                <li>
                    <a href="{{route('companies.index')}}">{{trans('admin.companies')}}</a>
                </li>
                <li class="active">
                    <strong>{{trans('admin.addCompany')}}</strong>
                </li>
            </ol>
        ...
        {{-- All Categories --}}
        @elseif (Route::is('forms.index'))
            <h2>{{trans('admin.forms')}}&nbsp;({{$forms->total()}})</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="{{route('admin')}}">{{trans('admin.home')}}</a>
                </li>
                <li class="active">
                    <strong>{{trans('admin.forms')}}</strong>
                </li>
            </ol>
